...
namespace SupportLibraryTest
{
    ...
    public class SqlTests
    {
        ...
        public void SqlHelper_Constructor_Valid()
        {
            // arrange
            string expectedConnString1 = "Data Source=LINK-PROD; database=Web; user id=msc-webservices; password=msc#*nvm2007!";
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.SqlHelper")]
        public void SqlHelper_ExecuteStored_Valid()
        {
            // arrange & act
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.SqlHelper")]
        public void SqlHelper_ExecuteStoredLog_FullLog_Valid()
        {
            // arrange
            ...
            DataTable dtActual = new SqlHelper("SupportLibrary").GetDataTable("sp_SupportLibrary_GetLogs", dateTimeStart);
            ...
            for (int i = 0; i < tuples.Count; i++)
            {
                ...
                Assert.AreEqual(entityName, tuples[i].Item1, "Assert 01");
                Assert.AreEqual(entityId, tuples[i].Item2, "Assert 02");
                Assert.IsTrue(user.StartsWith(@"ARGENTINA\"), "Assert 03");
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.SqlHelper")]
        public void SqlHelper_ExecuteStoredLog_LogReturnedValue_Valid()
        {
            // arrange
            DateTime dateTimeStart = DateTime.Now;
            ...
            for (int i = 0; i < tuples.Count; i++)
            {
                ...
                Assert.AreEqual(entityName, tuples[i].Item1, "Assert 01");
                Assert.AreEqual(entityId, 1234, "Assert 02");
                Assert.IsTrue(user.StartsWith(@"ARGENTINA\"), "Assert 03");
                Assert.IsTrue(logTime > dateTimeStart, "Assert 04");
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.SqlHelper")]
        public void SqlHelper_GetData_Valid()
        {
            // arrange
            ...
            // assert
            TestHelper.Data.AreEqual(dtExpected1, dtActual, "Assert 01");
            TestHelper.Data.AreEqual(dsExpected, dsActual, "Assert 02");
        }
    }
}
