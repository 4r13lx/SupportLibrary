...
namespace SupportLibraryTest
{
    ...
    public class DataTests
    {
        ...
        public void DataHelper_ReplaceDbNull_Valid()
        {
            // arrange
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ThrowIfDbNull_Valid()
        {
            // arrange
            DataTable dataTable = new DataTable("Table");
            dataTable.Columns.Add("StringColumn", Type.GetType("System.String"));
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ThrowIfDbNull_ThrowUsing_Exception_Valid()
        {
            // arrange
            DataTable dataTable = new DataTable("Table");
            dataTable.Columns.Add("StringColumn", Type.GetType("System.String"));
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ThrowIfDbNull_ThrowUsing_ErrorMessage_Valid()
        {
            // arrange
            DataTable dataTable = new DataTable("Table");
            dataTable.Columns.Add("StringColumn", Type.GetType("System.String"));
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ThrowIfDbNull_ThrowUsing_ExceptionType_Valid()
        {
            // arrange
            DataTable dataTable = new DataTable("Table");
            dataTable.Columns.Add("StringColumn", Type.GetType("System.String"));
        ...
        public void DataHelper_ThrowIfDbNull_ThrowUsing_Exception_Invalid()
        {
            // arrange
            DataTable dataTable = new DataTable("Table");
            dataTable.Columns.Add("StringColumn", Type.GetType("System.String"));
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        [ExpectedException(typeof(ArgumentNullException))]
        public void DataHelper_ThrowIfDbNull_ThrowUsing_ErrorMessage_Invalid()
        {
            // arrange
            DataTable dataTable = new DataTable("Table");
            dataTable.Columns.Add("StringColumn", Type.GetType("System.String"));
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        [ExpectedException(typeof(ArgumentNullException))]
        public void DataHelper_ThrowIfDbNull_ThrowUsing_ExceptionType_Invalid()
        {
            // arrange
            DataTable dataTable = new DataTable("Table");
            dataTable.Columns.Add("StringColumn", Type.GetType("System.String"));
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ToDataTable_EntitiesCollection_Valid()
        {
            // arrange
            List<TestEntity> lstEntities = new List<TestEntity>()
            {
                new TestEntity() { Id = 1, FirstName = "Pablo", LastName = "Gutierrez", Age = 20, Tall = 1.75F },
                new TestEntity() { Id = 2, FirstName = "Maria", LastName = "Lopez", Age = 30, Tall = 1.65F },
                new TestEntity() { Id = 3, FirstName = "Carlos", LastName = "Gonzalez", Age = 40, Tall = 1.70F }
            };
            ...
            // act
            DataTable dtActual = DataHelper.ToDataTable<TestEntity>("TestEntity", lstEntities, "FirstName", "LastName", "Age");

            // assert
            TestHelper.Data.AreEqual(dtExpected, dtActual, "Assert 01");
            Assert.AreEqual("TestEntity", dtActual.TableName, "Assert 02");
        }

        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ToDataTable_EntitiesCollection_Invalid()
        {
            // arrange
            List<TestEntity> lstEntities = new List<TestEntity>()
            {
            ...
            Action action1 = () => DataHelper.ToDataTable<TestEntity>(lstEntities, "FirstName", "InvalidPropertyName", "Age");
            Action action2 = () => DataHelper.ToDataTable<TestEntity>(lstEntities, "FirstName", null, "Age");
            ...
            ArgumentNullException exception2 = TestHelper.AssertThrows<ArgumentNullException>(action2, "Assert 03");
            Assert.AreEqual("propNames", exception2.ParamName, "Assert 04");
        }

        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ToDataTable_ValueTypeCollection_Valid()
        {
            // arrange
            ...
            // assert
            TestHelper.Data.AreEqual(dtExpectedInteger, dtActualInteger, "Assert 01");
            Assert.AreEqual("TableInt", dtActualInteger.TableName, "Assert 02");

            TestHelper.Data.AreEqual(dtExpectedString, dtActualString, "Assert 03");
        }

        [TestMethod, TestPropertyAttribute("Unit Tests", "Data.DataHelper")]
        public void DataHelper_ToDataTable_ValueTypeCollection_Invalid()
        {
            // arrange
            List<int> lstInteger = new List<int>() { 2, 5, 9, 7, 2, 3 };
            ...
            // act & assert
            ArgumentNullException exception1 = TestHelper.AssertThrows<ArgumentNullException>(action1, "Assert 01");
            Assert.AreEqual("list", exception1.ParamName, "Assert 02");
            
            ArgumentException exception2 = TestHelper.AssertThrows<ArgumentException>(action2, "Assert 03");
            Assert.AreEqual("columnName", exception2.ParamName, "Assert 04");

            ArgumentNullException exception3 = TestHelper.AssertThrows<ArgumentNullException>(action3, "Assert 05");
