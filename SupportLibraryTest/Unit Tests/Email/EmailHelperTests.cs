...
namespace SupportLibraryTest.Email
{
    /// <summary>
    ...
    public class EmailHelperTests
    {
        ...
        public void EmailHelper_IsValidEmailAddress()
        {
            ...
            bool result07 = EmailHelper.IsValidEmailAddress("test@asd.coop");               // good
            bool result08 = EmailHelper.IsValidEmailAddress("@");                           // wrong, incomplete address
            bool result09 = EmailHelper.IsValidEmailAddress("@asd");                        // wrong, incomplete address
            bool result10 = EmailHelper.IsValidEmailAddress("@asd.com");                    // wrong, incomplete address
            bool result11 = EmailHelper.IsValidEmailAddress("test");                        // wrong, incomplete address
            bool result12 = EmailHelper.IsValidEmailAddress("test@");                       // wrong, incomplete address
            bool result13 = EmailHelper.IsValidEmailAddress("test@asd");                    // wrong, incomplete address
            bool result14 = EmailHelper.IsValidEmailAddress("test@asd.");                   // wrong, incomplete address
            bool result15 = EmailHelper.IsValidEmailAddress("te st@asd.com");               // wrong, incomplete address
            bool result16 = EmailHelper.IsValidEmailAddress("test.asd.com");                // wrong, incomplete address
            bool result17 = EmailHelper.IsValidEmailAddress("test test@asd.com");           // wrong, spaces are not allowed
            bool result18 = EmailHelper.IsValidEmailAddress("te#st@asd.com");               // wrong, invalid character '#'
            bool result19 = EmailHelper.IsValidEmailAddress("tést@asd.com");                // wrong, invalid character 'é'
            bool result20 = EmailHelper.IsValidEmailAddress("");                            // wrong, empty string
            bool result21 = EmailHelper.IsValidEmailAddress(null);                          // wrong, null value
            ...
            Assert.AreEqual(true, result07, "Assert 07");
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Email")]
        public void EmailHelper_SplitAddresses()
        {
            // arrange
        ...
        [TestMethod, TestPropertyAttribute("Unit Tests", "Email")]
        public void EmailHelper_SplitAddresses_FailsOnInvalidArgs()
        {
            try
            {
                // arrange
                string textValid = "asd@test.com, qwerty@test.com";         // valid text (with default delimiters)
                string textInvalid1 = "asd@test.com @ qwerty@test.com";     // invalid text (with default delimiters)
                string textInvalid2 = "asd@test.com . qwerty@test.com";     // invalid text (with default delimiters)

                Action action1 = () => EmailHelper.SplitAddresses(textValid, '*');
                Action action2 = () => EmailHelper.SplitAddresses(textInvalid1);
                Action action3 = () => EmailHelper.SplitAddresses(textInvalid1, '@');
                Action action4 = () => EmailHelper.SplitAddresses(textInvalid2);
                Action action5 = () => EmailHelper.SplitAddresses(textInvalid2, '.');

                // act
                ArgumentException exception1 = AssertEx.Exceptions.Throws<ArgumentException>(action1, "Assert 01");
                ArgumentException exception2 = AssertEx.Exceptions.Throws<ArgumentException>(action2, "Assert 02");
                ArgumentException exception3 = AssertEx.Exceptions.Throws<ArgumentException>(action3, "Assert 03");
                ArgumentException exception4 = AssertEx.Exceptions.Throws<ArgumentException>(action4, "Assert 04");
                ArgumentException exception5 = AssertEx.Exceptions.Throws<ArgumentException>(action5, "Assert 05");
