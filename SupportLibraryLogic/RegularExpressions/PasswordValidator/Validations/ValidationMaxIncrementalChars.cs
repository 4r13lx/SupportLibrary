...
{
    /// <summary>
    /// Internal class to validate a password for incremental secuences.<para/>
    /// </summary>
    sealed class ValidationMaxIncrementalChars : ValidationBase
    {
        ...
        public ValidationMaxIncrementalChars(params object[] args)
            : base(args)
        {
            base.ValidationType = ValidationType.MaxIncrementalChars;
        ...
        public override bool Validate(string password)
        {
            ...
            for (int i = 1; i < password.Length; i++)
            {
                ...
                if (AreIncrementalChars(prevChar, currentChar)) { secuenceCount++; } else { secuenceCount = 0; }
        ...
        private bool AreIncrementalChars(char a, char b)
        {
